...
# from bo.bo.doctype.lpd.xlsutils import build_csv_response
from bo.bo.utils.xlsutils import build_xlsx_response
...
class Exporter:
	def __init__(
		...
		self.export_protect_area=export_protect_area
	...
	def build_xlsx_response(self):		
		build_xlsx_response(self.get_csv_array_for_export(), self.doctype, self.export_protect_area)
