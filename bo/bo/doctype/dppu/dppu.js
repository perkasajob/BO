    ...
    if(frappe.user.has_role("CSD")){
        frm.add_custom_button(__('Get Dx Rex'), function(){
            frappe.db.get_value("Dx", {"name": frm.doc.dx_user},["no_rek","nama_rek", "bank", "saldo","is_id"], function(v) {           
                frappe.msgprint('<table><tr><td>Nama :&nbsp</td><td>'+v.nama_rek +'</td></tr><table><tr><td>NRek :&nbsp</td><td>'+ v.no_rek +'</td></tr><table><tr><td>Saldo :&nbsp</td><td>' + v.saldo +'</td></tr><table><tr><td>IS id   :&nbsp</td><td>'+ v.is_id +'</td><td>','Dx');
