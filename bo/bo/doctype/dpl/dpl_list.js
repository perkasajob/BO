		...
		listview.page.add_action_item(__('Dwnld Distro XLS'), function(e,o){
			...
			if (names.length > 0){
				...
				open_url_post(method, {
					doctype: listview.doctype,
					file_type: "Excel",
					export_fields: {[listview.doctype]:["name","outid", "start_date", "end_date", "distributor","line","is_outlet_id","apl_outid","ppg_outid","tsj_outid"],"items":["name","item_code","item_name","hna","dpl_disc","hna2","dpl_disc1","nsv2_ppn","apl_item_code","apl_item_name","ppg_item_code","ppg_item_name","tsj_item_code","tsj_item_name"]},
					export_filters: export_filters,
